# imports pygame (free/open source library used for making multimedia applications)
import pygame
...
#Study Drills:
# Flow chats are basically code in visual form. It shows you the steps your code takes till the end.